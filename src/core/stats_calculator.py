    ...
    def _process_match(self, match_id: str, match_data: Dict[str, Any], 
        ...
        for team in teams:
            for ban in team.get("bans", []):
                ...
                # Note: We need championId to name mapping (Data Dragon)
                # For now, we'll skip bans if we don't have the mapping
                # This can be added later with champion.json from Data Dragon
